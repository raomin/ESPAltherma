...
LabelDef labelDefs[] = {
//  int registryIDp, int offsetp, int convidp, int dataSizep, int dataTypep, const char *labelp
...
{0x21,4,101,2,-1,"Voltage (N-phase) (V)"}, // Added from list_labels.csv as an experiment
...
//{0x61,14,105,2,1,"Ext. indoor/outdoor ambient sensor (R6T)"},
