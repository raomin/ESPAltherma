...
//{0x63,12,303,1,-1,"Temp. éch. chaleur O/U(R4T)"},
//{0x63,12,302,1,-1,"Not translated yet"},
//{0x63,12,301,1,-1,"Not translated yet"},
//{0x63,12,300,1,-1,"Not translated yet"},
//{0x63,17,311,1,-1,"BUH capacité de sortie"},
//{0x63,17,161,1,-1,"Mesure du capteur CT (L1)"},
//{0x63,17,161,1,-1,"Mesure du capteur CT (L2)"},
//{0x63,18,307,1,-1,"HP forcé FG"},
//{0x63,19,161,1,-1,"Mesure du capteur CT (L3)"},
