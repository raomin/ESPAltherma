...
//{0x10,6,114,2,1,"Temp. de refoulement cible"},
...
//{0xA1,0,119,2,1,"Température d entrée de l échangeur de chaleur"},
//{0xA1,2,119,2,1,"Température de sortie de l échangeur thermique"},
