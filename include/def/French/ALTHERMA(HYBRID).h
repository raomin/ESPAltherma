...
//{0x3*,0,211,1,-1,"Ventilateur 1 (10 rpm)"},
//{0x3*,1,211,1,-1,"Ventilateur 2 (palier)"},
//{0x3*,0,151,2,-1,"Détendeur électronique1 (pls)"},
...
//{0x3*,0,307,1,-1,"Vanne à 4 voies 1"},
