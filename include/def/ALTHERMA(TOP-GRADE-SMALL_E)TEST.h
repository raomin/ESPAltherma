...
//{0x63,8,105,2,1,"[HPSU] Mixed leaving water temperature after the tank DLWA2"},
//{0x63,10,152,1,-1,"[HPSU] Tank valve position (0:Bypass 100:Tank)"},
//{0x63,11,152,1,-1,"[HPSU] Bypass valve position (0:Bypass 100:Emitter)"},
//{0x63,12,307,1,-1,"Tank state (bit7)"},
//{0x63,12,306,1,-1,"Tank state (bit6)"},
...
//{0x63,12,303,1,-1,"O/U Heat Exch. Temp.(R4T)"},
...
//{0x63,17,311,1,-1,"BUH output capacity"},
//{0x63,17,161,1,-1,"Current measured by CT sensor of L1"},
//{0x63,17,161,1,-1,"Current measured by CT sensor of L2"},
//{0x63,18,307,1,-1,"HP Forced FG"},
//{0x63,19,161,1,-1,"Current measured by CT sensor of L3"},
