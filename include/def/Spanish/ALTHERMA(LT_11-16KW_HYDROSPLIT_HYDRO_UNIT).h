...
//{0x30,2,151,2,-1,"Válvula de expansión (pls)"},
//{0x30,4,307,1,-1,"Válvula de 4 vías 1"},
//{0x30,4,306,1,-1,"Válvula de 4 vías 2"},
//{0x30,4,305,1,-1,"Válvula de 4 vías 3"},
//{0x30,4,304,1,-1,"Válvula de 4 vías 4"},
//{0x30,4,303,1,-1,"Válvula de 4 vías 5"},
//{0x30,10,113,1,1,"Temperatura del agua de entrada. (DMW)"},
//{0x30,11,113,1,1,"Salida de agua hex. Temp. antes de BUH (DLWB2)"},
