...
//{0x30,8,303,1,-1,"Calentador del cárter 5"},
//{0x30,9,307,1,-1,"Válvula solenoide 1"},
//{0x30,9,306,1,-1,"Válvula solenoide 2"},
...
//{0x62,15,105,2,2,"Sensor de presión"},
//{0x62,17,307,1,-1,"No se utiliza"},
//{0x62,17,306,1,-1,"No se utiliza"},
//{0x62,17,305,1,-1,"No se utiliza"},
//{0x62,17,304,1,-1,"No se utiliza"},
//{0x62,17,303,1,-1,"No se utiliza"},
//{0x62,17,302,1,-1,"No se utiliza"},
//{0x62,17,301,1,-1,"No se utiliza"},
//{0x62,17,300,1,-1,"No se utiliza"},
