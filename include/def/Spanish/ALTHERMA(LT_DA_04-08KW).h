...
//{0x3*,0,211,1,-1,"Ventilador 1 (10 rpm)"},
//{0x3*,1,211,1,-1,"Ventilador 2 (nivel)"},
//{0x3*,0,151,2,-1,"Válvula de expansión (pls)"},
...
//{0x3*,0,307,1,-1,"Válvula solenoide 1"},
//{0x3*,0,306,1,-1,"Válvula solenoide 2"},
