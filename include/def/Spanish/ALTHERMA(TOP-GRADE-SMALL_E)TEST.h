...
//{0x63,12,303,1,-1,"Temp. Intercambiador U/Ext(R4T)"},
//{0x63,12,302,1,-1,"Not translated yet"},
//{0x63,12,301,1,-1,"Not translated yet"},
//{0x63,12,300,1,-1,"Not translated yet"},
//{0x63,17,311,1,-1,"Capacidad de salida BUH"},
//{0x63,17,161,1,-1,"Medición del sensor CT (L1)"},
//{0x63,17,161,1,-1,"Medición del sensor CT (L2)"},
//{0x63,18,307,1,-1,"HP forzado FG"},
//{0x63,19,161,1,-1,"Medición del sensor CT (L3)"},
