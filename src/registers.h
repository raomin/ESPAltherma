...
public:
    ...
    char asString[30];
    LabelDef(){};
    LabelDef(int registerIDp, int offsetp, int convidp, int dataSizep, int dataTypep, const char *labelp) : convid(convidp), offset(offsetp), registerID(registerIDp), dataSize(dataSizep), dataType(dataTypep), label(labelp){};
};
